...
## Data Frames
```{r}
data.frame(person = c("Greg","Steve","Mary"), 
           height = c(67, 68, 60),
           age = c(41, 20, 42), 
...
#scatterplot 
ggplot(aes(x = area, y = pop),data = CIACountries) + geom_point()
...
ggplot(aes(x = pop),data = CIACountries) + geom_histogram(aes(y = ..density..)) + geom_density()
