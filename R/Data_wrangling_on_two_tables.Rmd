...
data1 %>% inner_join(data2, by = c("key" = "key")) # 
data1 %>% inner_join(data3, by = c("key" = "key"))
data2 %>% inner_join(data3, by = c("key" = "key"))

data1 %>% left_join(data2, by = c("key" = "key"))
data1 %>% left_join(data3, by = c("key" = "key"))
data2 %>% left_join(data3, by = c("key" = "key"))

data2 %>% left_join(data1, by = c("key" = "key"))
data3 %>% left_join(data1, by = c("key" = "key"))
data3 %>% left_join(data2, by = c("key" = "key"))

data1 %>% full_join(data2, by = c("key" = "key"))
data1 %>% full_join(data3, by = c("key" = "key"))
