...
summ %>% pivot_wider(names_from = inspection_type, values_from = pass_rate) %>% dygraph() %>% dyOptions(colors = RColorBrewer::brewer.pal(3, "Set1"))


summ %>% pivot_wider(names_from = inspection_type, values_from = pass_rate) %>% dygraph() %>% dyOptions(colors = c("orange","purple","green"))
